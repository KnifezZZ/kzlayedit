    ...
    var setIframe = function (editor, textArea, set) {
        ...
        , insertInline = function (tagName, attr, range) {
            ...
            if (device.ie) { //IE
                ...
                setTimeout(function () {
                    debugger;
                    iframeDOM.documentElement.focus();
                    iframeDOM.documentElement.getElementsByTagName("span")[0].focus()
                    //elem.focus();
                }, 10);
            }
        }
                            ...
                            rbtnIndex = layer.open({
                                ...
                                offset: function () {
                                    if (/mobile/i.test(navigator.userAgent)) {
                                        ...
                                        return [event.clientY + parentNode.getBoundingClientRect().y + "px", function () {
                                            var x = event.clientX;
                                            if (x + 100 + 30 > parentNode.getBoundingClientRect().width) {
                                                x = x - 100 - 30;
                                            }
                                            return x + "px";
                                        }];
